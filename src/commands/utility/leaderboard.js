    ...
    async execute(interaction) {
        try {
            ...
            const leaderboard = users.map(user => {
                ...
                const power = inventory.wood + inventory.palmLeaves + 4 * inventory.rope + inventory.stone + 2 * inventory.copper + 5 * inventory.gold + 50 * inventory.ruby + 250 * inventory.diamond;
                return {
